...
Diese Eigenschaft nutzt man in allen Anwendungen als das essentielle
Werkzeug, um das jeweilige Ziel im gewünschten Wellenbereich zu erreichen.

Im Folgenden haben wird die Simulation des bereits besprochenen Reflexions- und
...
ermittelt werden und um einige Rechenoperationen zu sparen, nutzen wir die
Transfermatrixmethode.
\subsection{Reflexion und Transmission}
Im allgemeinen kann man die Reflexion und Transmission von elektromagnetischen
Wellen, an einer Grenzfläche zwischen zwei Schichten, mit den
\textit{fresnelschen Formeln} ermitteln.

Ein wichtiger Aspekt den man hier mit einbezieht ist die Polarisation.
Abhänhgig davon ob Polarisation senkrecht oder parallel vorliegt, varrieren die
Formeln.
