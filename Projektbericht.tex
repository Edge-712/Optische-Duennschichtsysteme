...
Abbildung~\ref{fig:Reflexion} dargestellt. Um dieses Problem zu lösen wird die
...
\begin{figure}[h!]
    \centering
    \includegraphics[scale=0.3]{./assets/Teilwellen.pdf}
...
800 nm mit einem senkrechten Einfallswinkel.
\begin{table}[h]
    \centering
...
dieses Schichtsystem bei extremem Ultraviolettlicht eine passende Dicke der
Schichten zu ermitteln, um optimale Reflexivität zu garantieren.
\begin{table}[htpb]
    \centering
...
\end{figure}
Die idealen Werte für den senkrechten Einfall sind in Tabelle~\ref{tab:Schicktdicke} zu sehen.
Das Ergebnis in Abbildung~\ref{fig:Ergebnis2-0} ist die gewünschte Funktion für die EUV-Schicht
