...
\begin{itemize}
    ...
    \item den Parameter \texttt{n\_type} der die Art der Berechnung des Brechungsindex
          definiert,
    \item die Schichtdicke \texttt{d} (bei Halbräumen: $d = \infty$),
    \item den optionalen Parameter \texttt{A} für die Sellmeier-Gleichung,
    \item den optionalen B-Koeffizienten der Sellmeier-Gleichung,
    \item den optionalen C-Koeffizient der Sellmeier-Gleichung,
    \item einen optionalen festen Brechungsindex,
    \item eine optionale Benutzerdefinierte Formel zur Bestimmung des Brechungsindex,
    \item und optionale Messdaten zur Ermittlung des Brechungsindex durch Interpolation.
\end{itemize}
